...
class MongoDocumentTest extends CTestCase
{
	...
	{
		$c = User::model();
		$this->assertInstanceOf('\Mongo\Document', $c);
	}

	/**
	 * @covers \Mongo\Document::save
	 */
	...
	/**
	 * @covers \Mongo\Document::findBy_id
	 */
	...
	/**
	 * @covers \Mongo\Document::findAllByPk
	 */
	public function testFindAllByPk()
	{
		...
		$this->assertInstanceOf('\Mongo\Cursor', $r);
	...
	/**
	 * @covers \Mongo\Document::updateByPk
	 */
	public function testUpdateByPk()
	{
		...
		$this->assertInstanceOf('\Mongo\Document', $r);
		$this->assertEquals('gfgfgf', $r->username);
	}

	/**
	 * @covers \Mongo\Document::deleteByPk
	 */
	...
	/**
	 * @covers \Mongo\Document::updateAll
	 */
	...
	/**
	 * @covers \Mongo\Document::deleteAll
	 */
	...
	/**
	 * @covers \Mongo\Document::saveAttributes
	 */
	public function testSaveAttributes()
	{
		...
		$c->username = 'radagast';
		$c->job_title = 'wizard';
		$this->setExpectedException('\Mongo\Exception');
	...
	public function testOneRelation()
	{
		...
		$r = User::model()->findOne();
		$this->assertInstanceOf('\Mongo\Document', $r->one_interest);
	}
	...
	public function testManyRelation()
	{
		...
		//$this->assertInstanceOf('\Mongo\Cursor', $r->many_interests);
	...
	public function testEmbeddedRelation()
	{
		...
		$r = User::model()->findOne();
		// No longer valid due to relation caching
		//$this->assertInstanceOf('\Mongo\Cursor', $r->embedInterest);
	...
	public function testWhereRelation()
	{
		$this->setUpRelationalModel();
		$r = User::model()->findOne();
		$this->assertInstanceOf('\Mongo\Cursor', $r->where_interest);
	}
	...
	public function testFunctionalRelation()
	{
		...
		// No longer valid due to relation caching
		//$this->assertInstanceOf('\Mongo\Cursor', $rel);
	...
	/**
	 * @covers \Mongo\Document::getAttributeLabel
	 */
