...
class Client/* extends CApplicationComponent*/
{
	...
	public function connect()
	{
		if(!extension_loaded('mongo')){
			throw new Exception('We could not find the MongoDB extension ( http://php.net/manual/en/mongo.installation.php ), please install it');
		}
	...
	/**
	 * Sets the document cache for any particular document (\Mongo\Document/EMongoModel)
	 * sent in as the first parameter of this function.
	 * Will not cache actual \Mongo\Document/EMongoModel instances
	...
	{
		throw new \Kohana\Exception('Add functional');
